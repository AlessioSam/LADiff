...
class SMPLH(Rots2Joints):
    ...
    def forward(self,
        ...
        # from ladiff.tools.easyconvert import to_matrix
...
def smplh_to(jointstype, data, trans):
    from ladiff.utils.joints import get_root_idx

    if "mmm" in jointstype:
        from ladiff.utils.joints import smplh2mmm_indexes
        ...
        from ladiff.utils.joints import smplh2smplnh_indexes
