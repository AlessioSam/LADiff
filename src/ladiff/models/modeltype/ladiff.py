import inspect
import os
from ladiff.transforms.rotation2xyz import Rotation2xyz
import numpy as np
import torch
...
from ladiff.models.architectures import (
    ladiff_denoiser,
    ladiff_vae,
    vposert_vae,
    t2m_motionenc,
...
from ladiff.models.losses.mld import MLDLosses
from ladiff.models.modeltype.base import BaseModel
from ladiff.utils.temos_utils import remove_padding
from ladiff.models.operator.position_encoding import PositionEmbeddingSine, PositionEmbeddingSine1D

from .base import BaseModel

class LADIFF(BaseModel):
    """
    Stage 1 vae
    Stage 2 diffusion
    """
    ...
    def __init__(self, cfg, datamodule, **kwargs):
        ...
        if self.stage == "diffusion":
            if self.vae_type in ["ladiff","mld", "vposert","actor"]:
    ...
    def forward(self, batch, latentwise_gen=None, plot_att_map=None):
        ...
        with torch.no_grad():
            ...
            if self.vae_type in ["ladiff","mld","actor"]:
                if latentwise_gen:
    ...
    def t2m_eval(self, batch):
        ...
        if self.stage in ['diffusion', 'vae_diffusion']:
            ...
            text_emb = self.text_encoder(texts)
            z = self._diffusion_reverse(text_emb, lengths) # z is [max_it, batch_size, latent_dim[1]]
