...
def main():
    ...
    #if cfg.TEST.RESUME_STAGE1:
    #    print("Loading pretrain Stage1 model")
    #    # Load weights of Stage1
    #    state_dict = torch.load(cfg.TEST.RESUME_STAGE1,map_location="cpu")["state_dict"]
        # Load only model.vae weights
