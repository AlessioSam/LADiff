...
parser.add_argument("--gpu_ids", type=int, default=1, help="choose gpu ids")
...
for path in paths:
    dir_save = os.path.join(
        opt.save_folder, "results_smplfitting", "SMPLFit2_" + os.path.basename(path)[:-4])
    ...
    if data.shape[1] > 1000:
        print(f"npy is a mesh now {dir_save}")
        continue
    ...
    print("merging ply to npy for mesh rendering...")
